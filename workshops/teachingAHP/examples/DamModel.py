...
damModel=cdf_str.Model() #create model
...
criteria_cluster2.addNode2Cluster(criteria_node1) #add nodes to criteria cluster
criteria_cluster2.addNode2Cluster(criteria_node2)
criteria_cluster2.addNode2Cluster(criteria_node3)
criteria_cluster2.addNode2Cluster(criteria_node4)
...
criteria_cluster3.addNode2Cluster(criteria_node31) #add nodes to Decision Makers cluster
criteria_cluster3.addNode2Cluster(criteria_node32)
criteria_cluster3.addNode2Cluster(criteria_node33)
criteria_cluster3.addNode2Cluster(criteria_node34)
criteria_cluster3.addNode2Cluster(criteria_node35)
...
criteria_cluster4.addNode2Cluster(criteria_node41) #add nodes to Factors cluster 4
criteria_cluster4.addNode2Cluster(criteria_node42)
criteria_cluster4.addNode2Cluster(criteria_node43)
criteria_cluster4.addNode2Cluster(criteria_node44)
criteria_cluster4.addNode2Cluster(criteria_node45)
criteria_cluster4.addNode2Cluster(criteria_node46)
...
criteria_cluster5.addNode2Cluster(criteria_node51) #add nodes to cluster 5
criteria_cluster5.addNode2Cluster(criteria_node52)
criteria_cluster5.addNode2Cluster(criteria_node53)
criteria_cluster5.addNode2Cluster(criteria_node54)
...
criteria_cluster6.addNode2Cluster(criteria_node61) #add nodes to cluster 6
criteria_cluster6.addNode2Cluster(criteria_node62)
criteria_cluster6.addNode2Cluster(criteria_node63)
criteria_cluster6.addNode2Cluster(criteria_node64)
criteria_cluster6.addNode2Cluster(criteria_node65)
criteria_cluster6.addNode2Cluster(criteria_node66)
...
cdf_inp.export4ExcelQuestFull(damModel,"./Examples/IO Files/excelDamModel.xlsx",True)